...
+function ($) {
  ...
  Layout.prototype.fix = function () {
    ...
    if ($('body').hasClass(ClassName.fixed)) {
        $(Selector.contentWrapper).css('min-height', windowHeight - footerHeight - headerHeight-90);
        console.log(windowHeight + "-(1) " + footerHeight);
    } else {
      var postSetHeight;
      ...
      //  console.log(postSetHeight + "- (2)" + neg);
      //} else {
      //  $(Selector.contentWrapper).css('min-height', sidebarHeight);
      //  postSetHeight = sidebarHeight;
      //  console.log(sidebarHeight + "- (3)" + postSetHeight);
      //}
      $(Selector.contentWrapper).css('min-height', windowHeight - footerHeight - headerHeight - 90);
