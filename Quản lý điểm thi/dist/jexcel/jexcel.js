...
;(function (global, factory) {
    ...
    var jexcel = (function(el, options) {
        ...
        var defaults = {
            ...
            // Texts
            text:{
                noRecordsFound: 'Không có bản ghi nào được tìm thấy',
                showingPage: 'Hiển thị trang {0} của {1} bản ghi',
                show: 'Hiển thị ',
                search: 'Tìm kiếm',
                entries: ' bản ghi',
                columnName: 'Tên cột',
                //insertANewColumnBefore: 'Thêm cột mới phía trước',
                //insertANewColumnAfter: 'Thêm cột mới phía sau',
                //deleteSelectedColumns: 'Xóa cột đã chọn',
                renameThisColumn: 'Đổi tên cột',
                orderAscending: 'Sắp xếp tăng dần',
                orderDescending: 'Sắp xếp giảm dần',
                insertANewRowBefore: 'Thêm một dòng mới phía trước',
                insertANewRowAfter: 'Thêm một dòng mới phía sau',
                deleteSelectedRows: 'Xóa dòng đã chọn',
                editComments: 'Sửa chú thích',
                addComments: 'Thêm chú thích',
                comments: 'Chú thích',
                clearComments: 'Xóa chú thích',
                copy: 'Copy...',
                paste: 'Paste...',
                saveAs: 'Lưu thành...',
                about: 'Thông tin',
                areYouSureToDeleteTheSelectedRows: 'Bạn có chắc xóa dòng đã chọn?',
                areYouSureToDeleteTheSelectedColumns: 'Bạn có chắc xóa cột đã chọn??',
            ...
            if (! jexcel.current.edition && jexcel.current.selectedCell) {
                ...
                if (e.which == 37) {
                    ...
                    if (e.shiftKey) {
                        ...
                        if (jexcel.current.options.allowInsertColumn == true) {
                            if (jexcel.current.options.allowManualInsertColumn == true) {
                                do{
                                    ...
                                    console.log(jexcel.current.selectedCell[0]);
                                }
                                while (jexcel.current.getCellFromCoords(jexcel.current.selectedCell[0], jexcel.current.selectedCell[1]).classList.contains('readonly') == true);
                            }
                        ...
                        //cell.classList.contains('readonly') == true
                        //var columnId = ;
                        //while (jexcel.current.options.columns[columnId].readOnly == true)
                        //{
                        //    jexcel.current.right();
                        //}
                    }
